...
public class BookingOfficeServiceImpl implements BookingOfficeService {
  ...
  @Override
  public void addBookingOffice(BookingOfficeCreationDTO dtoCreate) throws NotFoundException {
  ...
  @Override
  public void updateBookingOffice(BookingOfficeCreationDTO dtoCreate, Long id) throws NotFoundException {
