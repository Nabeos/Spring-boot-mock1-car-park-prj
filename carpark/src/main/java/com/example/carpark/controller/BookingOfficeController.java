...
public class BookingOfficeController {
  ...
  public String addBookingOffice(@RequestBody @Valid BookingOfficeCreationDTO dtoCreate) throws NotFoundException {
  ...
  public String updateBookingOffice(@RequestBody @Valid BookingOfficeCreationDTO dtoCreate, @PathVariable Long id) throws NotFoundException {
